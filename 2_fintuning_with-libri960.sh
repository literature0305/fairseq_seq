...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
    ...
    cat $combined_data_dir/wav_dir.tsv > $combined_data_dir/train.tsv
    cat $combined_data_dir/labels.ltr > $combined_data_dir/train.ltr
    cat $combined_data_dir/labels.wrd > $combined_data_dir/train.wrd
